...
urlpatterns = [
    ...
    path('admin_dashboard/delete_contact_message/<int:message_id>/', views.delete_contact_message, name='delete_contact_message'),
    path('admin_dashboard/view_contact_message/<int:message_id>/', views.view_contact_message, name='view_contact_message'),
